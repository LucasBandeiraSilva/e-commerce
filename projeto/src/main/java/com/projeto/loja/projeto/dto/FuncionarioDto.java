...
public record FuncionarioDto(
        ...
        @CPF(message = "Formato de cpf inválido.") @Column(unique = true) String cpf,

        @Size(min = 6, message = "the password must be longer than 6 characters") @Size(max = 50, message = "the password must be shorter than 50 characters") String senha,
